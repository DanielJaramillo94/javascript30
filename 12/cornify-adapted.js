...
var cornify_add = function(options) {
    ...
    var cornify_url = 'https://danieljaramillo94.github.io/javascript30/12/';
    var numType = 'px';
    ...
    const gifs =  ['kratos', 'shadow', 'yoshi'];
    const colors =  ['eb8686', 'b7e8e8', 'b7e8be'];
    const index = Math.floor(Math.random() * 3);

    let url = `https://danieljaramillo94.github.io/javascript30/12/${gifs[index]}.gif`;
...
var cornify_updatecount = function() {
    ...
    if(cornify_count == 1) {
        ...
        p.innerHTML = 'You died '+cornify_count+' times!';
    }
